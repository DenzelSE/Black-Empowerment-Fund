            ...
            <Card className="shadow-xl border-bef-purple/20 animate-fade-in">
              <CardHeader className="space-y-1 text-center">
                ...
                <p className="text-gray-500">
                  ...
                  {step === "approve allowance" && "Please approve your allowance to mint the NFT"}
                </p>
              </CardHeader>
              ...
              <CardContent className="space-y-6">
                ...
                {step === "approve allowance" && (
                  <div className="flex flex-col items-center py-8">
                    <div className="h-16 w-16 mb-6 bg-yellow-100 rounded-full flex items-center justify-center">
                      <AlertCircle className="h-8 w-8 text-yellow-500" />
                    </div>
                    <p className="text-gray-800 font-medium">Please approve your allowance</p>
                    <p className="text-sm text-gray-500 mt-1">You need to approve at least R1000</p>
                  </div>
                )}
